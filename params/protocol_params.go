...
const (
	MaximumExtraDataSize  uint64 = 960    // Maximum size extra data may be after Genesis.
...
var (
	...
	MinGasLimit            = big.NewInt(5120000)               // Minimum the gas limit may ever be.
	GenesisGasLimit        = big.NewInt(8192000)               // Gas limit of the Genesis block.
	...
	// was 13 -- create block interval time
)
