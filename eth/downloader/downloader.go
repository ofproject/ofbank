...
fmt.Println("*****************SYNC TD:", td)
	...
	if !atomic.CompareAndSwapInt32(&d.synchronising, 0, 1) {
		fmt.Println("******************** error two *********************", d.synchronising) //nancy
		return errBusy
	}
...
fmt.Println("*************************** Hash TD *************************", td, "===>" ,d.lightchain.GetTdByHash(d.lightchain.CurrentHeader().Hash()))
						return errStallingPeer
					}
				}
